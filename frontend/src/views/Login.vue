...
<template>
  <div class="px-1 sm:px-10 max-w-xl py-5 mx-auto">
    <div class="mx-auto rounded w-full h-1/2 bg-light p-5 text-center shadow-lg border">
      <img src="../assets/images/logo.png" class="text-center mx-auto object-contain w-3/4" />
