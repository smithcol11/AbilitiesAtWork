...
<template>
  <nav id="nav-bar" class="hidden sm:block transition duration-300">
    <div
      class="sm:w-32 sm:h-screen shadow-sm text-center duration-300 bg-light text-dark dark:bg-darkGrayAccent dark:text-light dark:border-r-2 dark:border-r-darkGrayAccent"
    >
      <img
      ...
      />
      <RouterLink
        class="nav-button dark:hover:bg-darkGray dark:border-b-darkGray"
        to="/clientMenu"
      >
        Client Menu
      </RouterLink>
      ...
      <button
        class="w-full py-2 border-b-2 sm:py-3 text-center flex justify-center hover:bg-accentDark hover:text-light dark:hover:bg-darkGray dark:text-light dark:border-b-darkGray"
        @click="toggleLogout()"
      >
        Logout
      </button>
  ...
  <button
    class="sm:hidden nav-button flex mx-auto border-b border-x shadow-l bg-light dark:bg-darkGrayAccent dark:border-darkGrayAccent"
    @click="toggleNav()"
  >
    <svg
  ...
  >
    <div
      class="w-72 h-28 shadow-lg mx-auto bg-light dark:bg-darkGray mt-24 p-5"
    >
